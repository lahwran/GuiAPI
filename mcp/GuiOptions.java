...
public class GuiOptions extends GuiScreen {
   ...
   public void initGui() {
      ...
      this.controlList.add(new GuiButton(101, this.width / 2 - 100, this.height / 6 + 96, var1.translateKey("options.video")));
      this.controlList.add(new GuiButton(100, this.width / 2 - 100, this.height / 6 + 120, var1.translateKey("options.controls")));
