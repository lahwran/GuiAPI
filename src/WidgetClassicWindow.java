...
public class WidgetClassicWindow extends Widget {
	public String Title = "";
	...
	public WidgetClassicWindow(Widget w)
	{
	...
	public WidgetClassicWindow(Widget w, String s)
	{
		ScrollPane mainwidget_ = new ScrollPane(w);
		mainwidget_.setFixed(ScrollPane.Fixed.HORIZONTAL);
		mainwidget = mainwidget_;
